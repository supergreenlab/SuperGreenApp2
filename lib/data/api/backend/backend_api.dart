...
class BackendAPI {
  ...
  void initAndroidDevUrls() async {
    ...
    if ((await deviceInfo.androidInfo).isPhysicalDevice) {
      bool local = true;
      serverHost = local ? 'http://192.168.1.50:8080' : 'https://devapi2.supergreenlab.com';
      websocketServerHost = local ? 'ws://192.168.1.50:8080' : 'wss://devapi2.supergreenlab.com';
      storageServerHost = local ? 'http://192.168.1.50:9000' : 'https://devstorage.supergreenlab.com';

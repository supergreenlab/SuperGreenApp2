...
class FeedEntriesCardHelpers {
  static Map<
      String,
      Widget Function(Animation<double> animation, FeedState feedState,
          FeedEntryState state,
    ...
    'FE_CLONING': (animation, feedState, state, {cardActions}) =>
        FeedCloningCardPage(animation, feedState, state,
            cardActions: cardActions),
    ...
    'FE_TIMELAPSE': (animation, feedState, state, {cardActions}) =>
        FeedTimelapseCardPage(animation, feedState, state,
            cardActions: cardActions),
  };
  ...
  static Widget cardForFeedEntry(
    ...
    Widget Function(Animation<double>, FeedState, FeedEntryState,
        {List<Widget> Function(
                BuildContext context, FeedEntryState feedEntryState)?
            cardActions})? builder = _cards[state.type];
    if (builder == null) {

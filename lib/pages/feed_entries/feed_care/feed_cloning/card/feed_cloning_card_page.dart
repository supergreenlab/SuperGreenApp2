...
class FeedCloningCardPage extends FeedCareCommonCardPage {
  static String get feedCloningCardPageTitle {
    return Intl.message(
      'Cloning',
      name: 'feedCloningCardPageTitle',
      desc: 'Cloning card title',
  ...
  String iconPath() {
    return FeedEntryIcons[FE_CLONING]!;
  }

  @override
  String title() {
    return FeedCloningCardPage.feedCloningCardPageTitle;
  }
}

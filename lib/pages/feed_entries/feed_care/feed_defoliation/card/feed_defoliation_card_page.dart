...
class FeedDefoliationCardPage extends FeedCareCommonCardPage {
  ...
  FeedDefoliationCardPage(Animation animation, FeedState feedState, FeedEntryState state, {Key key, cardActions})
  ...
  @override
  String title() {
    return FeedDefoliationCardPage.feedDefoliationCardPageTitle;
  }
}

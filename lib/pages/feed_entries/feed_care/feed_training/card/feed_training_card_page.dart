...
import 'package:super_green_app/pages/feed_entries/feed_care/feed_care_common/card/feed_training_card_bloc.dart';
...
abstract class FeedTrainingCardPage<CardBloc extends FeedTrainingCardBloc>
    extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CardBloc, FeedTrainingCardBlocState>(

                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Checkbox(value: deleteLocalData, onChanged: (bool? checked) {
                              setState(() {
                                deleteLocalData = !deleteLocalData;
                              });
                            }),
                            InkWell(child: Text('Delete local data too?'), onTap: () {
                              setState(() {
                                deleteLocalData = !deleteLocalData;
                              });
                            },),
                              ...
                              child: GreenButton(
                                ...
                                onPressed: nickname.text != '' &&  password.text != '' ? () {
                                  BlocProvider.of<DeleteAccountBloc>(context)
                                      .add(DeleteAccountBlocEventDelete(nickname.text, password.text));
                                } : null,
                              ),
                            ),
                          ],

...
class SettingsRemoteControlBlocEventInit
    extends SettingsRemoteControlBlocEvent {
  @override
  List<Object> get props => [];
}

class SettingsRemoteControlBlocEventPair
    extends SettingsRemoteControlBlocEvent {
  @override
  List<Object> get props => [];
}
...
class SettingsRemoteControlBlocStateInit
    extends SettingsRemoteControlBlocState {
  @override
  List<Object> get props => [];
}

class SettingsRemoteControlBlocStateLoaded
    extends SettingsRemoteControlBlocState {
  final Device device;
...
class SettingsRemoteControlBlocStateLoading
    extends SettingsRemoteControlBlocState {
  @override
  List<Object> get props => [];
}

class SettingsRemoteControlBlocStateDonePairing
    extends SettingsRemoteControlBlocState {
  final Device device;
...
class SettingsRemoteControlBloc extends LegacyBloc<
    SettingsRemoteControlBlocEvent, SettingsRemoteControlBlocState> {
  final MainNavigateToSettingsRemoteControl args;

  SettingsRemoteControlBloc(this.args)
      : super(SettingsRemoteControlBlocStateInit()) {
    add(SettingsRemoteControlBlocEventInit());
  }

  @override
  Stream<SettingsRemoteControlBlocState> mapEventToState(
      SettingsRemoteControlBlocEvent event) async* {

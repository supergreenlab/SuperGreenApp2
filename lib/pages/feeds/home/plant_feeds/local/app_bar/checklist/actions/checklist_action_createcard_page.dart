...
class ChecklistActionCreateCardButton extends ChecklistActionButton {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: AppBarAction(
        icon: FeedEntryIcons[
            (checklistAction as ChecklistActionCreateCard).entryType]!,
        color: FeedEntryColors[
            (checklistAction as ChecklistActionCreateCard).entryType]!,
        ...
        actionIcon: SvgPicture.asset(FeedEntryIcons[
            (checklistAction as ChecklistActionCreateCard).entryType]!),
      ),
    );
  }
  ...
  void Function() getAction(BuildContext context) {
    ...
    Map<String, void Function() Function(BuildContext)> onActions = {
      ...
      FE_TRANSPLANT: (BuildContext context) => _onAction(
              ...
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedTransplantFormEvent(plant,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
      ...
      FE_BENDING: (BuildContext context) => _onAction(
              context,
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedBendingFormEvent(
                      plant,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
              tipID: 'TIP_BENDING',
      ...
      FE_FIMMING: (BuildContext context) => _onAction(
              context,
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedFimmingFormEvent(plant,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
              tipID: 'TIP_FIMMING',
              tipPaths: [
      ...
      FE_TOPPING: (BuildContext context) => _onAction(
              context,
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedToppingFormEvent(plant,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
              tipID: 'TIP_TOPPING',
              tipPaths: [
      ...
      FE_DEFOLIATION: (BuildContext context) => _onAction(
              context,
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedDefoliationFormEvent(plant,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
      ...
      FE_NUTRIENT_MIX: (BuildContext context) => _onAction(
              context,
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedNutrientMixFormEvent(plant,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
              tipID: 'TIP_WATERING',
              tipPaths: [
      ...
      FE_SCHEDULE: (BuildContext context) => _onAction(
              context,
              ({pushAsReplacement = false}) =>
                  MainNavigateToFeedScheduleFormEvent(
                      box,
                      pushAsReplacement: pushAsReplacement,
                      futureFn: futureFn(context, plant)),
              tipID: 'TIP_BLOOM',
    ...
    return onActions[(checklistAction as ChecklistActionCreateCard).entryType]!(
        context);
  }
  ...
  Widget? _renderBody(BuildContext context) {
    ...
    String instructions =
        (checklistAction as ChecklistActionCreateCard).instructions ?? '';
    return Padding(
  ...
  void Function() _onAction(BuildContext context,

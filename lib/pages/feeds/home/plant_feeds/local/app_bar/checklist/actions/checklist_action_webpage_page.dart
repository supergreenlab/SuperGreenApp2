...
class ChecklistActionWebpageButton extends ChecklistActionButton {
  ...
  ChecklistActionWebpageButton({required Plant plant, required ChecklistSeed checklistSeed, required ChecklistAction checklistAction}) : super(plant: plant, checklistSeed: checklistSeed, checklistAction: checklistAction);

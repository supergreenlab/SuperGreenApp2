...
class ChecklistPhase extends StatelessWidget {
  ...
  const ChecklistPhase({Key? key, required this.phase, required this.onChange})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    List<Tuple3> choices = [
      ...
      Tuple3(
          PH_VEGGING, PlantPhaseNames[PH_VEGGING], PlantPhaseIcons[PH_VEGGING]),
      Tuple3(PH_BLOOMING, PlantPhaseNames[PH_BLOOMING],
          PlantPhaseIcons[PH_BLOOMING]),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "towelieBoxAlreadyStarted" : MessageLookupByLibrary.simpleMessage("Was this box **already started** when you added it to the app?"),
    "towelieBoxAutoOrPhoto" : MessageLookupByLibrary.simpleMessage("To better guide to a **successful harvest**, I\'ll need a bit **more informations** about your box:)\nIs this plant an **auto** or **photo** strain?"),
    "towelieBoxCreated" : MessageLookupByLibrary.simpleMessage("Awesome, **you created your first box**!\n\nYou can access your newly box feed either by **pressing the home button below**, or the **View box** button below.\n"),
    "towelieBoxTutoTakePic" : MessageLookupByLibrary.simpleMessage("Alright **let\'s start**!\nOne first thing you can do to **start** this journey is to **take a picture** of your **plant**."),
    "towelieBoxVegOrBloom" : MessageLookupByLibrary.simpleMessage("Is the plant in **veg** or **bloom**?"),
    "towelieCreateBox" : MessageLookupByLibrary.simpleMessage("Alright we\'re ready to create your **first box!**\n\nThe app works like this:\n- you **create a box**\n- attach it (or not) to a **SuperGreenController**\n- configure the led channels used to **light it up**\n\nOnce this is done, you will have access to it\'s **feed**, it\'s like a timeline of the **box\'s life**.\nWhenever you water, change light parameters, or train the plant, or any other action,\nit will log it in the box\'s feed, so you can **share it**, or **replay it** for your next grow!\n\nPress the **Create box** button below.\n"),
    ...
    "towelieHelperCreateBox" : MessageLookupByLibrary.simpleMessage("Hey man, **welcome to the box creation process**, I\'ll be there to guide you through it.\nFirst step is to **give your new box a name**."),
    ...
    "towelieHelperSelectBoxDevice" : MessageLookupByLibrary.simpleMessage("Your controller can **manage up to 3 boxes**, select an **already configured** box above, or create a **new one**."),
    "towelieHelperSelectDevice" : MessageLookupByLibrary.simpleMessage("Alright, now that your box has a name we can **start its configuration**:)\nIf you own a **SuperGreenLab bundle**, you need to tell the app **which controller will control the box lights, ventilation and sensors**.\nBecause it\'s all brand new, let\'s first **setup a new controller**.\nIf you don\'t own a bundle, you can skip this by pressing \"NO SGL DEVICE\"."),
    "towelieHelperSelectNewBoxDevice" : MessageLookupByLibrary.simpleMessage("Ok, this is where we\'ll choose which of the **controller\'s LED channel** will be used to light up the plant.\nTo **better understand** you should have your LED panels **connected to the controller**."),

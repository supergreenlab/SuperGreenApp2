...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "towelieHelperSelectBoxDevice" : MessageLookupByLibrary.simpleMessage("Ok, this is where we\'ll choose which of the **controller\'s LED channel** will be used to light up the plant.\nTo **better understand** you should have your LED panels **connected to the controller**."),
    ...
    "towelieHelperSelectNewBoxDevice" : MessageLookupByLibrary.simpleMessage("Your controller can **manage up to 3 boxes**, select an **already configure** box above, or create a **new one**."),

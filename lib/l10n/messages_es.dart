...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "instructionsExistingDeviceTitle" : MessageLookupByLibrary.simpleMessage("Enter device name or IP"),
    ...
    "towelieHelperDeviceWifi" : MessageLookupByLibrary.simpleMessage("**While not mandatory**, connecting your device to your home wifi has a few benefits:\n- receive software **upgrade** and bug fixes\n- remote **monitoring**\n- remote **control** (coming soon)"),
    "towelieHelperSelectBoxDevice" : MessageLookupByLibrary.simpleMessage("Your controller can **manage up to 3 boxes**, select an **already configure** box above, or create a **new one**."),

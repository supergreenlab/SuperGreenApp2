...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "toweliePlantStartSeedling" : MessageLookupByLibrary.simpleMessage("Alright, let me know when you\'re **ready to start** by pressing the button below.\nIn the meantime you can also **create an account**:P that will enable backups, remote control, sharing, etc..."),

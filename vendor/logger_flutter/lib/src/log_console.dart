...
class FlutterLogOutput extends ConsoleOutput {
  static final Set<OutputCallback> _outputCallbacks = {};

  void output(OutputEvent event) {
    for (OutputCallback callback in _outputCallbacks) {
      callback(event);
    }
    super.output(event);
  }
...
class LogConsole extends StatefulWidget {
  ...
  static void init({int bufferSize = 20}) {
    ...
    _initialized = true;
    FlutterLogOutput.addOutputListener((e) {
...
class _LogConsoleState extends State<LogConsole> {
  ...
  void initState() {
    ...
    FlutterLogOutput.addOutputListener(_callback);
  ...
  @override
  void dispose() {
    FlutterLogOutput.removeOutputListener(_callback);
    super.dispose();
  }
}
